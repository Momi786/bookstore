            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <img class="d-block " src="../img/book.jpg" alt="First slide">
                  </div>
                  <div class="carousel-item">
                     <img class="d-block" src="../img/book.jpg" alt="Second slide">
                  </div>
                  <div class="carousel-item">
                     <img class="d-block" src="../img/book.jpg" alt="Third slide">
                  </div>
               </div>
            ...
            <div class="m-2">
               <div class="">
                  <figure class="figure tag tag-featured mb-0">
                     <img src="../img/book.jpg" alt="featured image" class="figure-img">
                  </figure>
         ...
         <div class="row pt-3 pb-3">
            <div class="col-md-6">
               ...
               <div class="box-white">
                  <div class="row">
                     <div class="col-md-5">
                  <img src="../img/book.jpg" class="imh-fluid m-3" alt="" style="width: 204px; height: 291px;border-radius:13px;">
            ...
            <div class="col-md-6">
               <div class="row p-3">
                  ...
                  <div class="col-md-4 col-sm-6 col-6">
                     <img src="../img/book.jpg" class="imh-fluid p-2" alt="" style="width: 130px; height: 225px;border-radius:13px">
                  </div>
                  <?php endfor;?>
               </div>
            </div>
